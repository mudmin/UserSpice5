...
$lang = array_merge($lang, array(
    ...
    "2FA_ERR_INVALID_CODE"               => "Неверный код аутентификации. Пожалуйста, попробуйте еще раз.",
...
$lang = array_merge($lang, array(
	...
	"SET_NOCHANGE_EMAIL"	=> "Администратор отключил изменение адресов электронной почты.",
...
$lang = array_merge($lang, array(
	"REAUTH_TITLE"            => "Подтвердите, что это вы",
	"REAUTH_INTRO"            => "В целях безопасности подтвердите свою личность, чтобы продолжить.",
	"REAUTH_RELOGIN"          => "Войдите снова, чтобы продолжить.",
	"REAUTH_LOCKED"           => "Слишком много неудачных попыток. Войдите снова.",
	"REAUTH_VERIFY"           => "Подтвердить",
	"REAUTH_OR"               => "или",
	"REAUTH_PASSWORD_LABEL"   => "Ваш пароль",
	"REAUTH_BAD_PASSWORD"     => "Неверный пароль.",
	"REAUTH_TOTP_BACKUP"      => "Это резервный код",
	"REAUTH_EMAIL_BTN"        => "Отправить мне 6-значный код по эл. почте",
	"REAUTH_EMAIL_CODE_LABEL" => "Введите 6-значный код",
	"REAUTH_EMAIL_RESEND"     => "Отправить новый код",
	"REAUTH_EMAIL_SUBJECT"    => "Код подтверждения",
	"REAUTH_EMAIL_BODY"       => "Ваш код подтверждения:",
	"REAUTH_EMAIL_EXPIRE"     => "Срок действия этого кода истекает через 10 минут. Если вы его не запрашивали, проигнорируйте это письмо.",
	"REAUTH_EMAIL_SENT"       => "Мы отправили вам 6-значный код по эл. почте.",
	"REAUTH_EMAIL_FAIL"       => "Не удалось отправить письмо. Попробуйте другой способ.",
	"REAUTH_EMAIL_NONE"       => "Сначала запросите код.",
	"REAUTH_EMAIL_EXPIRED"    => "Срок действия кода истёк. Запросите новый.",
	"REAUTH_EMAIL_TOOMANY"    => "Слишком много попыток. Запросите новый код.",
	"REAUTH_EMAIL_BAD"        => "Неверный код.",
	"REAUTH_PASSKEY_BTN"      => "Использовать ключ доступа",
	"REAUTH_SOCIAL_BTN"       => "Подтвердить через",
	"REAUTH_SOCIAL_MISMATCH"  => "Эта учётная запись не совпадает с вашим входом. Попробуйте снова.",
));

// 2FA verification page (totp_verification.php) custom keys
$lang = array_merge($lang, array(
	"2FA_VERIFY_TROUBLE"   => "Возникли проблемы с приложением для аутентификации?",
	"2FA_BACKUP_CODE_HELP" => "Введите один из сохранённых резервных кодов",
	"2FA_USE_BACKUP_BTN"   => "Использовать резервный код",
));
