      ...
      <div class="col-12 col-sm-6">
        ...
        <div class="form-group">
          ...
          <select class="form-control mb-2" name="private" required>
            <option value="0"
            <?php if($pageDetails->private == 0){ echo "selected='selected'";}?>
            >This Page is Public</option>
            <option value="1"
            <?php if($pageDetails->private == 1){ echo "selected='selected'";}?>
        ...
        <div class="form-group">
          ...
          foreach ($permissionData as $v1) {
            if (!in_array($v1->id, $perm_ids)) { ?>
              ...
              <?php if ($settings->page_permission_restriction == 1) {?><label class="normal"><input type="radio" name="addPermission[]" id="addPermission[]" value="<?php echo $v1->id; ?>"
                <?php if ($countCountQ > 0 || $pageDetails->private == 0) { ?> disabled <?php } ?>>
