        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <!-- Site Offline -->
              <div class="form-group">
                <label>Site Offline <a tabindex="-1"  data-trigger="focus" data-bs-trigger="focus" data-placement="top" class="btn btn-link text-info px-0"  title="Need to go into Maintenance Mode to do an upgrade? Enable this! This will display a 'Maintenance Mode Active' message for those in the default Administrator permission group (ID: 2) and redirect the remaining to the maintenance page. This will occur until the setting is disabled.Â Default: No."><i class="fa fa-question-circle offset-circle"></i></a></label>
