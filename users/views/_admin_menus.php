...
<div class="content mt-3">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <table class="table table-bordered table-hover table-condensed" id="menuTable">
            <thead><tr><th>ID</th><th>Menu Name</th><th>Menu Type</th><th>Z-Index</th><th>Status</th><th class="text-end">Actions</th></tr></thead>
            <tbody>
            <?php
            $i=0;
  ...
  <script>
    $(document).ready( function () {
      $('#menuTable').DataTable({"pageLength": 25,"stateSave": true,"aLengthMenu": [[25, 50, 100, -1], [25, 50, 100, "All"]], "aaSorting": []});
    } );
